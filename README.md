...
- The game consists of 10 rounds, each requiring more points to pass than the last.
- The letter bag starts with some black, unusable tiles, and more are added with each round.
